...
* https://github.com/hyperpolymath/formbd[FormBD] - The narrative-first database (source of truth)
* https://github.com/hyperpolymath/formbd-studio[FormBD Studio] - GUI (map visualization target)
* https://github.com/hyperpolymath/formbd-analytics[FormBD Analytics] - OLAP analytics engine
