...
//!
//! This module provides spatial indexing for FormBD documents.
//! The index is a materialized projection - FormBD remains the source of truth.
...
impl SpatialEntry {
    ...
    pub fn new(formbd_id: String, lat: f64, lon: f64) -> Self {
        Self {
            formbd_id,
