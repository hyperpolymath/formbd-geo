...
(meta
  (architecture-decisions
    ...
    (adr
      ...
      (status "accepted")
      (date "2025-01-16")
      (context "Need to expose spatial queries as a service that other FormBD ecosystem tools can consume")
    ...
    (adr
      ...
      (status "accepted")
      (date "2025-01-16")
      (context "FormBD documents may store locations in various formats")
  ...
  (design-rationale
    ...
    (why-separate-repo
      "FormBD's philosophy explicitly deprioritizes performance (Auditability > Performance). Spatial queries require optimized data structures. Separation maintains FormBD's principles while enabling fast spatial lookups.")
    (why-in-memory-index
